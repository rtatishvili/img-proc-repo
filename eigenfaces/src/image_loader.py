...
def load_images(start=0, end=2429):    
    '''
    Load the range of the images according to the naming convention of images (hardcoded at the moment).
    (Note that files are enumerated from 1, thus file enumeration is shifted down by one).
