...
class Test_quantisation_intervals_should(unittest.TestCase):


    def test_by_default_count_to_8(self):
        
        intervals = q.quantisation_intervals()
    ...
    def test_have_boundaries_at_almost_same_distance(self):

        actual = q.quantisation_intervals(3)
