...
class Test(unittest.TestCase):
    ...
    def test_return_array_of_length_256(self):
        ...
        self.assertEqual(expected, actual, 'Probability density should have 256 elements')
    ...
    def test_return_array_with_sum_of_one(self):
        ...
        self.assertEqual(expected, actual, 'Probability density does not sum up to one')
